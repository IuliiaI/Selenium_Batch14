...
//        get all the ids from the columns
        ...
        //List<WebElement> columnID = driver.findElements(By.xpath("//table[@id='resultTable']/tbody/tr/td[2]")); - we put
        //it in while loop because when page is refreshed the webelements were found on first page then diccarded on the next page
